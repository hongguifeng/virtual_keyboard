...
public sealed class KeyInputSenderTests
{
    ...
    [InlineData(WindowsKeyboardKey.S, 0x1F)]
    [InlineData(WindowsKeyboardKey.D, 0x20)]
    [InlineData(WindowsKeyboardKey.F, 0x21)]
    [InlineData(WindowsKeyboardKey.G, 0x22)]
    ...
    [InlineData(WindowsKeyboardKey.Z, 0x2C)]
    [InlineData(WindowsKeyboardKey.X, 0x2D)]
    [InlineData(WindowsKeyboardKey.C, 0x2E)]
    [InlineData(WindowsKeyboardKey.V, 0x2F)]
